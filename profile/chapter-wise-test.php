...
<body>
    ...
    <div class="prf-header d-flex align-items-center justify-content-between">
        <p class="header-title">Chapter Wise Test</p>
        ...
        <div class="dpp-grid">
            <div>
                <div class="inner-head-box pb-0">
                    <h4 class="inner-heading">Physics</h4>
                </div>
                <div class="content-wrap">
                    <ul class="papper-cell m-0">
                        <li>
                            <h6>Chapter-1: Chapter Name</h6>
                            <div class="btn-con">
                                <a class="light btn-primary"><i class="fas fa-clipboard Test mr-3"></i>Take Test</a>
                            </div>
                        </li>
                        <li>
                            <h6>Chapter-1: Chapter Name</h6>
