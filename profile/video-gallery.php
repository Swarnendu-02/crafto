...
<body>
    ...
    <div class="prf-header d-flex align-items-center justify-content-between">
        <p class="header-title">Video Gallery</p>
    ...
    <div class="content-area">
        <div class="sub-header d-flex align-items-center justify-content-between mb-4">
            ...
            <div class="d-flex align-items-center justify-content-end">
                <a href="javascript:void(0);" class="tablinks active-a" data-id="physics">Physics</a>
                <a href="javascript:void(0);" class="tablinks" data-id="chemistry">Chemistry</a>
            </div>
        </div>
