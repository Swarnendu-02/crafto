...
<body>
    ...
    <div class="prf-header d-flex align-items-center justify-content-between">
        <p class="header-title">All India Test Series</p>
    ...
    <div class="content-area">
        <table class="table bg-white mb-0">
            ...
            <thead>
                <tr role="row">
                    <th>#</th>
                    <th style="width:30% ;">All India Test</th>
                    <th>Take Test</th>
                    <th>Download Question paper & Analysis</th>
            ...
            <tbody>
                <tr>
                    ...
                    <td>
                        <div class="btn-con">
                            <a class="light btn-primary"><i class="fas fa-clipboard"></i></a>
                        </div>
                    </td>
                    <td>
                        <div class="btn-con">
                            <a class="light btn-success"><i class="fas fa-file "></i></a>
                        </div>
                    <td>
                        <div class="btn-con">
                            <a class="light btn-info"><i class="fas fa-download"></i></a>
                        </div>
                    </td>
                    <td><span class="badge light badge-success">AIR</span></td>
                </tr>
                <tr>
                    <td>1</td>
                    <td>Series 2</td>
